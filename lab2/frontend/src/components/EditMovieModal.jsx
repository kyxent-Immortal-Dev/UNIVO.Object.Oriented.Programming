...
import { updateMovie } from '../services/api/movies.service';
import Swal from 'sweetalert2';

export default function EditMovieModal({ isOpen, onClose, movie, onMovieUpdated }) {
  ...
  useEffect(() => {
    if (movie) {
      ...
      const yearDate = movie.year ? new Date(movie.year) : new Date();
      const yearFormatted = yearDate.toISOString().split('T')[0];
      
      const fecha_ingreso = movie.fecha_ingreso 
        ? new Date(movie.fecha_ingreso).toISOString().split('T')[0]
